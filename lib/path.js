...
/**
 * _commentHint constant contains the tag to define a comment element into a 
 * {@link Path}.
 * @private
 */
...
class Path {
    ...
    /**
     * Path._nodeSiblings function returns the siblings nodes of provided one 
     * which is comments or has the same tag name.
     * @private
