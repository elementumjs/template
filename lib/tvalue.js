...
class TValue {
    ...
    constructor(path = null, value = null) {
        if (path !== null && typeof path !== 'string') {
            throw new TypeError('Bad patherence provided. Reference must be an string.', 'tvalue.js');
        }
    ...
    equalPath(path) {
        if (this.isRaw) {
            throw new Error('Current TValue is not a reference.', 'tvalue.js');
        }
    ...
    fromData(data) {
        ...
        throw new Error('No reference TValue provided.', 'tvalue.js');
    }
}
